    ...
    <div class="page-header float-right">
      <div class="page-title">
        <ol class="breadcrumb text-right">
          <li><a href="<?php echo site_url('registrar/dept/'.$this->uri->segment(3)); ?>">Kinder</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="card-body form-horizontal">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-3 col-xs-12">
                <input type="text" id="LRN" name="LRN" placeholder="Learner Reference Number" class="input-sm form-control-sm form-control resFld" data-parsley-type="number" maxlength="12" data-parsley-length="[12, 12]" data-parsley-length-message="" data-parsley-remote="check_stud_lrn" data-parsley-remote-options="{ 'type': 'GET', 'dataType': 'json', 'data': { 'LRN': 'value' } }" data-parsley-remote-message="LRN already exists">
              </div>
            </div><!-- /.row form-group -->
            <div class="row form-group">
              <div class="col col-sm-1 d-none d-sm-block">
        ...
        <div class="card">
          ...
          <div class="card-body form-horizontal">
            <div class="row form-group">
              <div class="d-none d-sm-block col-sm-1 col-xs-2" style="padding: 0px 0px 0px 15px;">
              ...
              <div class="col-sm-2 col-xs-6">
                <select class="input-sm form-control-sm form-control" name="stud_grade_lvl" required data-parsley-required-message="">
                  ...
                  <option value="Kinder 1">1</option>
                  <option value="Kinder 2">2</option>
                </select>
              </div><!-- col col-sm-3 -->
