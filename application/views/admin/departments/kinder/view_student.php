            ...
            <div class="card">
              ...
              <div class="card-body form-horizontal">
                <div class="row form-group">
                  ...
                  <div class="col-sm-1 col-xs-6">
                    <?php echo $stud_info->stud_grade_lvl ?>
                    <input type="hidden" id="gradeLevel" value="<?php echo $stud_info->stud_grade_lvl ?>">
                  </div><!-- col col-sm-3 -->
                  <div class="d-none d-sm-block col col-sm-1">
                    <label for="stud_acad_yr" class="form-control-label">S.Y.:</label>
                  </div><!-- col col-sm-1 -->
                        ...
                        <td>
                          <div class="checkbox">
                            <label for="<?php echo $fee->row_id ?>" class="form-check-label ">
                              <input type="checkbox" name="paymentCode[<?php echo $fee->row_id ?>]" id="<?php echo $fee->row_id ?>" data-name="<?php echo $fee->fee_name ?>" data-id="<?php echo $fee->row_id ?>" class="fees form-check-input" value="<?php echo $fee->row_id ?>"> <?php echo $fee->fee_name; ?>
                            </label>
                          </div>
                        </td>
                        <td>
