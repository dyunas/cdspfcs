    ...
    <div class="page-header float-right">
      <div class="page-title">
        <ol class="breadcrumb text-right">
          <li><?php echo anchor(site_url('registrar/dept/'.$this->uri->segment(3)), 'Kinder'); ?></li>
      ...
      <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <div class="card-footer">
            <button type="button" id="uploadMod" data-toggle="modal" data-target="#uploadModal" data-backdrop="static" data-keyboard="false" class="btn btn-sm btn-outline-primary ml-4"><i class="ti ti-plus"></i> Upload Avatar</button>
          </div>
        </div><!-- /.card -->
      </div><!-- /.col-md-3 -->
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3 col-xs-6">
                    <select class="input-sm form-control-sm form-control" name="stud_grade_lvl" required data-parsley-required-message="">
                      ...
                      <option value="Kinder 1" <?php echo ($stud_info->stud_grade_lvl == 'Kinder 1') ? 'selected' : '' ?>>1</option>
                      <option value="Kinder 2" <?php echo ($stud_info->stud_grade_lvl == 'Kinder 2') ? 'selected' : '' ?>>2</option>
                    </select>
                  </div><!-- col col-sm-3 -->
...
<script src="<?php echo base_url('assets/assets/js/pages/assessor/kinder/assessment.js'); ?>"></script>
<script src="<?php echo base_url('assets/assets/js/pages/assessor/kinder/assessmentInfo.js'); ?>"></script>
<script src="<?php echo base_url('assets/assets/js/pages/registrar/kinder/uploadAvatar.js'); ?>"></script>
<script src="<?php echo base_url('assets/assets/js/pages/registrar/kinder/paymentHistory.js'); ?>"></script>
<script src="<?php echo base_url('assets/assets/js/pages/registrar/kinder/stud_frm_validation.js'); ?>"></script>