      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <a href="<?php echo site_url('registrar/dept/kinder/new'); ?>" class="btn btn-sm btn-primary pull-right"><i class="ti ti-plus"></i> Register new student</a>
          </div><!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    var dtble = jQuery('#elemTbl').DataTable({
      ...
      "ajax": {
        type: "POST",
        url: 'kinder/get_kinder_table_data',
        dataType: 'json'
      }
    });
  });
