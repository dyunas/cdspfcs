                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          <table class="table">
                            ...
                            <tbody>
                              <?php $fees = $this->elemdb->get_school_fees($row->gradeLevel); ?>
                              <?php if($fees): ?>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3 col-xs-6">
                    <select class="input-sm form-control-sm form-control" name="stud_grade_lvl" required data-parsley-required-message="">
                      ...
                      <option value="Grade 1" <?php echo ($stud_info->stud_grade_lvl == 'Grade 1') ? 'selected' : '' ?>>1</option>
                      <option value="Grade 2" <?php echo ($stud_info->stud_grade_lvl == 'Grade 2') ? 'selected' : '' ?>>2</option>
                      <option value="Grade 3" <?php echo ($stud_info->stud_grade_lvl == 'Grade 3') ? 'selected' : '' ?>>3</option>
                      <option value="Grade 4" <?php echo ($stud_info->stud_grade_lvl == 'Grade 4') ? 'selected' : '' ?>>4</option>
                      <option value="Grade 5" <?php echo ($stud_info->stud_grade_lvl == 'Grade 5') ? 'selected' : '' ?>>5</option>
                      <option value="Grade 6" <?php echo ($stud_info->stud_grade_lvl == 'Grade 6') ? 'selected' : '' ?>>6</option>
                    </select>
                  </div><!-- col col-sm-3 -->
...
<script src="<?php echo base_url('assets/assets/js/pages/registrar/elementary/uploadAvatar.js'); ?>"></script>
