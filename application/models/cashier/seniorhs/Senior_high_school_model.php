...
class Senior_high_school_model extends CI_Model {
	...
	{
		$this->db->select('a.rowID, a.gradeLevel, a.assessmentID, a.paymentScheme, a.discount, a.totalDiscount, a.totalDiscAmount, a.voucher, a.voucherDisc, a.totalAmt, a.grandTotal, b.grd_lvl, c.discount');
